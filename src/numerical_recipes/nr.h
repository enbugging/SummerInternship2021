...
complex<DP> hypgeo(const complex<DP> &a, const complex<DP> &b, const complex<DP> &c, const complex<DP> &z);
...
void odeint(Vec_IO_DP &ystart, const DP x1, const DP x2, const DP eps, const DP h1, const DP hmin, int &nok, int &nbad, void derivs(const DP, Vec_I_DP &, Vec_O_DP &),
...
void powell(Vec_IO_DP &p, Mat_IO_DP &xi, const DP ftol, const int maxstep, int &iter, DP &fret, DP func(Vec_I_DP &));
void powell_intra(Vec_IO_DP &p, Mat_IO_DP &xi, const DP ftol, const int maxstep, int &iter, DP &fret, Vec_IO_DP &ParamCurrent, DP func(Vec_I_DP &));
...
void red(const int iz1, const int iz2, const int jz1, const int jz2, const int jm1, const int jm2, const int jmf, const int ic1, const int jc1, const int jcf, const int kc, Mat3D_I_DP &c,
         Mat_IO_DP &s);
